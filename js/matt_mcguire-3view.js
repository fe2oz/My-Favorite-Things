$(function(){
    ...
    $(".video-choice-list-2 li:nth-of-type(6)").click(function(){
        $(".count-2").html("6");
    });

    $(".video-choice-list-2 li:nth-of-type(7)").click(function(){
        $(".count-2").html("7");
    });

    $(".video-choice-list-2 li:nth-of-type(8)").click(function(){
        $(".count-2").html("8");
    });

    $(".video-choice-list-2 li:nth-of-type(9)").click(function(){
        $(".count-2").html("9");
    });

    $(".video-choice-list-2 li:nth-of-type(10)").click(function(){
        $(".count-2").html("10");
    });
